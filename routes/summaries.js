...
router.get("/X", async (req, res) => {
    ...
    if (global.parameters.summaries.print == true) {
        printResponse = printMng.printSummaryReport("ΑΝΑΛΥΣΗ ΤΑΜΕΙΟΥ:", lastColeDate[0].day_closure_datetime, formattedSummaries)
    }
...
router.get("/Z", async (req, res) => {
    ...
    let printResponse = false
    if (global.parameters.summaries.print == true) {
        printResponse = printMng.printSummaryReport("ΚΛΕΙΣΙΜΟ ΤΑΜΕΙΟΥ:", lastColeDate[0].day_closure_datetime, formattedSummaries)
    }
    if (global.parameters.summaries.email == true) {
